...
<html ng-app="app" class="ng-scope"><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style>
    <meta charset="utf-8">
    <title ng-bind="title">Ionic Starter Template</title>
    <style>
      body {
  ...
  <body cz-shortcut-listen="true">
    <div id="header-left">
      ...
      <a class="repoTitle" href="https://github.com/jdnichollsc/Ionic-Starter-Template">Ionic Starter Template</a>
      -
      <a class="repoTitle" href="https://github.com/jdnichollsc/Ionic-Starter-Template/blob/master/gulpfile.js">Deployed using Gulp</a>
    </div>
    <!--
    <header id="header">
    ...
    <preview class="ng-scope">
      ...
      <div class="phone">
        <div id="iphone">
          <h2><a href="www/index.html?ionicplatform=ios" target="_blank">iOS</a></h2>
          <iframe id="iphone-frame" src="www/index.html?ionicplatform=ios" class="frame"></iframe>
        </div>
      </div>
      <div class="phone">
        <div id="android">
          <h2><a href="www/index.html?ionicplatform=android" target="_blank">Android</a></h2>
          <iframe id="android-frame" src="www/index.html?ionicplatform=android" class="frame"></iframe>
        </div>
      </div>
    </preview>
    <!--
